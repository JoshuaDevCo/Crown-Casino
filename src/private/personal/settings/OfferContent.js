...
import { updateRefferal } from '../../../services/settingsService'
          ...
          <div className='justify-between items-center flex flex-col'>
            ...
            <form>
              <div className='flex-col flex p-3 my-2 border-b-2 border-slate-600'>
                ...
                <input onChange={(e) => setReferenceCode(e.target.value)} className="border-2 text-white border-slate-500 rounded-md p-2 bg-slate-800 md:w-96"
                  type="text"></input>
              </div>
